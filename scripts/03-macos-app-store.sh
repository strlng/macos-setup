...
mas install 1289378661 #Twitterrific (5.3.9)
mas install 1289197285 #MindNode (5.2.6)
mas install 1091189122 #Bear (1.6.10)
...
mas install 462058435 #Microsoft Excel (16.22)
mas install 462054704 #Microsoft Word (16.22)
mas install 462062816 #Microsoft PowerPoint (16.22)
mas install 803453959 #Slack (3.3.2)
mas install 975937182 #Fantastical 2 (2.5.4)
mas install 1116599239 #NordVPN IKE (4.11.7)
mas install 1346203938 #OmniFocus (3.2.1)
mas install 472226235 #LanScan (6.1.0)
